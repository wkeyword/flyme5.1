...
.method static synthetic access$000(Landroid/content/Context;IZ)V
    .locals 0
...
.method static shutdownInner(Landroid/content/Context;Z)V
    ...
    const-string v12, "power_menu_actions"
    ...
    const-string v12, "advanced_reboot_oneclick"
    ...
    .line 206
    .local v10, "uiContext":Landroid/content/Context;
    ...
    const v11, #android:string@reboot_safemode_title#t
    ...
    invoke-direct {v12, p0, v2}, Lcom/android/server/power/ShutdownThread$2;-><init>(Landroid/content/Context;Z)V
    ...
    iput-object v11, v3, Lcom/android/server/power/ShutdownThread$CloseDialogReceiver;->dialog:Landroid/app/Dialog;

    .line 256
    sget-object v11, Lcom/android/server/power/ShutdownThread;->sConfirmDialog:Landroid/app/AlertDialog;

    invoke-virtual {v11, v3}, Landroid/app/AlertDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    .end local v10    # "uiContext":Landroid/content/Context;
    :catchall_0
    move-exception v11
    ...
    .restart local v10    # "uiContext":Landroid/content/Context;
    :cond_b
    if-eqz v9, :cond_c

    const v11, #android:string@reboot_title#t

    goto :goto_5

    :cond_c
    const v11, #android:string@power_off#t
    ...
    const v11, #android:array@shutdown_reboot_options#t

    new-instance v12, Lcom/android/server/power/ShutdownThread$1;

    invoke-direct {v12, p0, v2}, Lcom/android/server/power/ShutdownThread$1;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v4, v11, v12}, Landroid/app/AlertDialog$Builder;->setItems(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    invoke-virtual {v4, v11, v12, v13}, Landroid/app/AlertDialog$Builder;->setSingleChoiceItems(IILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
