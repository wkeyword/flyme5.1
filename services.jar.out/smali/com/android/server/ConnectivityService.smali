...
.method private setProvNotificationVisible(ZILjava/lang/String;)V
    ...
    invoke-static {v0, v1, v6, v1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    :cond_3
    invoke-interface {v6, v7, v5, v3}, Landroid/os/INetworkManagementService;->createVirtualNetwork(IZZ)V
    :try_end_2
    ...
    invoke-interface {v3, v5}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(I)V
    :try_end_4
