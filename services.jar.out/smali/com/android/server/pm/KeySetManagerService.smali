...
.method public removeAppKeySetDataLPw(Ljava/lang/String;)V
    ...
    .prologue
    .line 416
    invoke-direct/range {p0 .. p1}, Lcom/android/server/pm/KeySetManagerService;->getOriginalKeySetsByPackageNameLPr(Ljava/lang/String;)Landroid/util/ArraySet;

    move-result-object v4

    .line 417
    .local v4, "deletableKeySets":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    new-instance v5, Landroid/util/ArraySet;

    invoke-direct {v5}, Landroid/util/ArraySet;-><init>()V

    .line 418
    .local v5, "deletableKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    invoke-virtual {v4}, Landroid/util/ArraySet;->size()I

    move-result v14

    .line 419
    .local v14, "origDksSize":I
    const/4 v8, 0x0
    ...
    iget-object v0, v0, Lcom/android/server/pm/KeySetManagerService;->mKeySetMapping:Landroid/util/LongSparseArray;
    ...
    .line 421
    .local v12, "knownKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    if-eqz v12, :cond_0

    .line 422
    invoke-virtual {v5, v12}, Landroid/util/ArraySet;->addAll(Landroid/util/ArraySet;)V
    ...
    .line 427
    .end local v12    # "knownKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    :cond_1
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/pm/KeySetManagerService;->mPackages:Ljava/util/Map;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/pm/KeySetManagerService;->getOriginalKeySetsByPackageNameLPr(Ljava/lang/String;)Landroid/util/ArraySet;

    move-result-object v11

    .line 432
    .local v11, "knownKeySets":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    invoke-virtual {v4, v11}, Landroid/util/ArraySet;->removeAll(Landroid/util/ArraySet;)Z
    ...
    .line 436
    .restart local v12    # "knownKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    if-eqz v12, :cond_3

    .line 437
    invoke-virtual {v5, v12}, Landroid/util/ArraySet;->removeAll(Landroid/util/ArraySet;)Z
    ...
    .line 444
    .end local v10    # "kksSize":I
    .end local v11    # "knownKeySets":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    .end local v12    # "knownKeys":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Long;>;"
    ...
    .line 447
    .local v13, "ks":Ljava/lang/Long;
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/pm/KeySetManagerService;->mKeySets:Landroid/util/LongSparseArray;
    ...
    invoke-virtual/range {v17 .. v19}, Landroid/util/LongSparseArray;->delete(J)V
    ...
    .line 450
    .end local v13    # "ks":Ljava/lang/Long;
    :cond_5
    ...
    iget-object v0, v0, Lcom/android/server/pm/KeySetManagerService;->mPublicKeys:Landroid/util/LongSparseArray;
    ...
    .line 460
    .restart local v13    # "ks":Ljava/lang/Long;
    iget-object v0, v15, Lcom/android/server/pm/PackageSetting;->keySetData:Lcom/android/server/pm/PackageKeySetData;
    ...
    invoke-virtual/range {v17 .. v19}, Lcom/android/server/pm/PackageKeySetData;->removeSigningKeySet(J)V
    ...
    .line 465
    .restart local v15    # "p":Lcom/android/server/pm/PackageSetting;
    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/server/pm/KeySetManagerService;->clearPackageKeySetDataLPw(Lcom/android/server/pm/PackageSetting;)V
