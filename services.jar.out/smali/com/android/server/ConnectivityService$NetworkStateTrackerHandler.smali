...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v2, v9, v1}, Lcom/android/server/ConnectivityService;->access$1200(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    .line 1956
    :cond_2
    iget-object v10, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->linkProperties:Landroid/net/LinkProperties;

    .line 1957
    .local v10, "oldLp":Landroid/net/LinkProperties;
    monitor-enter v9
    ...
    iput-object v1, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->linkProperties:Landroid/net/LinkProperties;
    ...
    .line 1960
    iget-boolean v1, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z
    ...
    invoke-static {v1, v9, v10}, Lcom/android/server/ConnectivityService;->access$1400(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V
    ...
    invoke-virtual {v1, v9, v2}, Lcom/android/server/ConnectivityService;->notifyNetworkCallbacks(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    .line 1968
    .end local v9    # "nai":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v10    # "oldLp":Landroid/net/LinkProperties;
    :sswitch_6
    iget-object v1, p0, Lcom/android/server/ConnectivityService$NetworkStateTrackerHandler;->this$0:Lcom/android/server/ConnectivityService;
    ...
    invoke-static {v1, v9, v8}, Lcom/android/server/ConnectivityService;->access$1500(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 1984
    .local v11, "score":Ljava/lang/Integer;
    if-eqz v11, :cond_0
    ...
    invoke-static {v1, v9, v2}, Lcom/android/server/ConnectivityService;->access$1600(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;I)V

    goto/16 :goto_0

    .line 1988
    .end local v9    # "nai":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v11    # "score":Ljava/lang/Integer;
    :sswitch_8
    iget-object v1, p0, Lcom/android/server/ConnectivityService$NetworkStateTrackerHandler;->this$0:Lcom/android/server/ConnectivityService;
    ...
    iput-boolean v14, v1, Landroid/net/NetworkMisc;->explicitlySelected:Z
    ...
    const-string v3, "EVENT_NETWORK_VALIDATED"
    ...
    invoke-static {v1, v9, v3}, Lcom/android/server/ConnectivityService;->access$1800(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)Z
    ...
    .local v13, "valid":Z
    :goto_1
    iput-boolean v13, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->lastValidated:Z

    .line 2032
    if-eqz v13, :cond_9

    .line 2034
    iget-boolean v1, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->everValidated:Z

    if-nez v1, :cond_9

    .line 2035
    iput-boolean v14, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->everValidated:Z

    .line 2036
    iget-object v1, p0, Lcom/android/server/ConnectivityService$NetworkStateTrackerHandler;->this$0:Lcom/android/server/ConnectivityService;

    sget-object v3, Lcom/android/server/ConnectivityService$NascentState;->JUST_VALIDATED:Lcom/android/server/ConnectivityService$NascentState;
    ...
    invoke-static {v1, v9, v3, v4}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$NascentState;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    ...
    invoke-static {v1, v9}, Lcom/android/server/ConnectivityService;->access$2000(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-static {v1, v9}, Lcom/android/server/ConnectivityService;->access$2100(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    :goto_2
    invoke-virtual {v1, v3, v14, v2, v5}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    # invokes: Lcom/android/server/ConnectivityService;->isLiveNetworkAgent(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)Z
    invoke-static {v1, v9, v2}, Lcom/android/server/ConnectivityService;->access$1800(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;)Z
    ...
    invoke-static {v1, v9}, Lcom/android/server/ConnectivityService;->access$2200(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    iget-object v2, v9, Lcom/android/server/connectivity/NetworkAgentInfo;->networkInfo:Landroid/net/NetworkInfo;
    ...
    invoke-static {v1}, Lcom/android/server/ConnectivityService;->access$2500(Ljava/lang/String;)V
    ...
    invoke-static {v1, v5}, Lcom/android/server/ConnectivityService;->access$2600(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;)V
